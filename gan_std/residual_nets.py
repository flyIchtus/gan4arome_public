...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 16 10:51:49 2021

@author: brochetc
Implement diverse Residual blocks

Directly inspired from :
    Gulrajani et al., 2017, Improved training of Wasserstein GANs
    Miyato et al., 2018 Spectral Normalisation for GANs
    Ravuri et al., 2021, Skilful precipitation nowcasting of rainfall
    using deep generative models of radar
...
class ResBlockDown(nn.Module):
    def __init__(self, input_channels, hidden_channels, output_channels):
        ...
        self.ConvShort=nn.Conv2d(input_channels, output_channels,(1,1),padding=0,\
                                 stride=(1,1), bias=False)
        
        self.Downscale=nn.AvgPool2d((2,2), stride=(1,1), padding=1)
...
class ResNet_D128(nn.Module):
    ...
    def __init__(self,input_channels):
        ...
        self.Model=nn.ModuleList([
                ResBlockDown(self.in_ch,self.in_ch, 64),
                ResBlockDown(64,64,128),
                ResBlockDown(128,128,256),
                ResBlockDown(256,256,512),
                ResBlockDown(512,512,1024),
...
class ResNet_D(nn.Module):
    ...
    def __init__(self, input_dim,input_channels):
        ...
        self.Model=nn.ModuleList(
                [ResBlockDown(channels[i],channels[i], channels[i+1])\
...
class ResNet_G128(nn.Module):
    ...
    def __init__(self, latent_dim, output_channels):
        ...
        #first dense layer
        self.Dense0=nn.Linear(latent_dim,128*128)
...
class ResNet_G(nn.Module):
    ...
    def __init__(self, latent_dim=128, output_dim=128, output_channels=4):
        ...
        self.HWo=output_dim
        #first dense layer
        self.Dense0=nn.Linear(latent_dim,128*latent_dim)
