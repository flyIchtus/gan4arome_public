...
def online_sample_plot(batch, n_samples, Step, var_names, path):
    ...
    for i, var in enumerate(var_names):
        ...
        for j in range(batch_to_print.shape[0]) :
            ...
            im=ax.imshow(b.cpu().detach().numpy(), cmap=cmap, vmin=-1.0, vmax=1.0)
