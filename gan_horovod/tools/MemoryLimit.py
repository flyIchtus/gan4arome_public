...
def toTheSky(input_dim, nz, input_channels, n0):
    ...
    while n<100:
        ...
        try :
            ...
            print("{} is the max batch size possible\
                 with those architectures".format(2**n))
            break
        cu.memory_summary()
        ###freeing memory ###
...
if __name__=="__main__":
    ...
    for input_dim in input_Dims:
        ...
        for nz in NZs:
            print("testing architectures with nz= {}, input_dim = {}".format(nz,input_dim) )
            
            n=toTheSky(input_dim, nz,4,n) # old n is new start as complexity increases