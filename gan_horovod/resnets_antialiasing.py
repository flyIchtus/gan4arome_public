...
class ResBlockUp(nn.Module):
    def __init__(self, input_channels, hidden_channels,output_channels,ksize=3):
        ...
        self.ReplicaPad=nn.ReplicationPad2d(1)
...
class ResNet_G(nn.Module):
    ...
    def __init__(self, latent_dim=128, output_dim=128, output_channels=4):
        ...
        self.SpecialPad=nn.ReflectionPad2d(2)
        self.ConvFinal=nn.Conv2d(channels[-1], output_channels, (4,4),padding=0,\
                                 stride=(1,1), bias=False)
    ...
    def forward(self, z):
        ...
        for m in self.Model:
            x1=m(x1)
        x1=self.ConvFinal(self.SpecialPad(self.relu0(self.BN0(x1))))
...
class ResBlockDown(nn.Module):
    def __init__(self, input_channels, hidden_channels, output_channels, ksize=3):
        ...
        #self.SpecialPad=nn.ReplicationPad2d(1)
        
        self.Downscale=nn.AvgPool2d((2,2), stride=(2,2), padding=1)
...
class ResNet_G128(nn.Module):
    ...
    def __init__(self, latent_dim, output_channels):
        ...
        self.relu0=nn.LeakyReLU(0.1)
        self.ConvFinal=nn.Conv2d(64, output_channels, (4,4),padding=2,\
                                 stride=(1,1), bias=False)
